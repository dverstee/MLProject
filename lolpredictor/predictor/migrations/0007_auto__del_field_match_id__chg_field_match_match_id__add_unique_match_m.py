...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'match.id'
        db.delete_column(u'predictor_match', u'id')


        # Changing field 'match.match_id'
        db.alter_column(u'predictor_match', 'match_id', self.gf('django.db.models.fields.CharField')(max_length=10, primary_key=True))
        # Adding unique constraint on 'match', fields ['match_id']
        db.create_unique(u'predictor_match', ['match_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'match', fields ['match_id']
        db.delete_unique(u'predictor_match', ['match_id'])

        # Adding field 'match.id'
        db.add_column(u'predictor_match', u'id',
                      self.gf('django.db.models.fields.AutoField')(default=1, primary_key=True),
                      keep_default=False)


        # Changing field 'match.match_id'
        db.alter_column(u'predictor_match', 'match_id', self.gf('django.db.models.fields.CharField')(max_length=10))
