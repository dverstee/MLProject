...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ChampionPlayed.champions_updated_at'
        db.add_column(u'predictor_championplayed', 'champions_updated_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 11, 27, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ChampionPlayed.champions_updated_at'
        db.delete_column(u'predictor_championplayed', 'champions_updated_at')
