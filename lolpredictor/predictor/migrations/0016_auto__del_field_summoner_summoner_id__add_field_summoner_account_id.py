...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'predictor_summoner', 'account_id',
                      self.gf('django.db.models.fields.CharField')(default='0', max_length=10, primary_key=True),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Summoner.summoner_id'
        raise RuntimeError("Cannot reverse this migration. 'Summoner.summoner_id' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Summoner.summoner_id'
    ...
    models = {
        ...
        u'predictor.summoner': {
            ...
            'account_id': ('django.db.models.fields.CharField', [], {'default': "'0'", 'max_length': '10', 'primary_key': 'True'}),
