...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Summoner',
            fields=[
                ('sid', models.IntegerField(default=b'0', serialize=False, primary_key=True)),
                ('name', models.CharField(max_length=20)),
                ('account_id', models.CharField(default=b'0', unique=True, max_length=10)),
                ('region', models.CharField(default=b'euw', max_length=20)),
