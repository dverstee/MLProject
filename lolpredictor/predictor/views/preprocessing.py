...
def preprocessMatch(matc, reverse):	
	...
	try:
		m=PreProcessedMatch.objects.create(match_id= matc.match_id,team1_is_red=matc.team1_is_red,nr_premade_team1=matc.nr_premade_team1,nr_premade_team2=matc.nr_premade_team2,
			won=matc.won,
