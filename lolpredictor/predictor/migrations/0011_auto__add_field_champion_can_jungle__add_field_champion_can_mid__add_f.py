...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Champion.can_jungle'
        db.add_column(u'predictor_champion', 'can_jungle',
                      self.gf('django.db.models.fields.BooleanField')(default=1),
                      keep_default=False)

        # Adding field 'Champion.can_mid'
        db.add_column(u'predictor_champion', 'can_mid',
                      self.gf('django.db.models.fields.BooleanField')(default=1),
                      keep_default=False)

        # Adding field 'Champion.can_top'
        db.add_column(u'predictor_champion', 'can_top',
                      self.gf('django.db.models.fields.BooleanField')(default=1),
                      keep_default=False)

        # Adding field 'Champion.can_adc'
        db.add_column(u'predictor_champion', 'can_adc',
                      self.gf('django.db.models.fields.BooleanField')(default=1),
                      keep_default=False)

        # Adding field 'Champion.can_support'
        db.add_column(u'predictor_champion', 'can_support',
                      self.gf('django.db.models.fields.BooleanField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Champion.can_jungle'
        db.delete_column(u'predictor_champion', 'can_jungle')

        # Deleting field 'Champion.can_mid'
        db.delete_column(u'predictor_champion', 'can_mid')

        # Deleting field 'Champion.can_top'
        db.delete_column(u'predictor_champion', 'can_top')

        # Deleting field 'Champion.can_adc'
        db.delete_column(u'predictor_champion', 'can_adc')

        # Deleting field 'Champion.can_support'
        db.delete_column(u'predictor_champion', 'can_support')
    ...
    models = {
        u'predictor.champion': {
            ...
            'can_adc': ('django.db.models.fields.BooleanField', [], {}),
            'can_jungle': ('django.db.models.fields.BooleanField', [], {}),
            'can_mid': ('django.db.models.fields.BooleanField', [], {}),
            'can_support': ('django.db.models.fields.BooleanField', [], {}),
            'can_top': ('django.db.models.fields.BooleanField', [], {}),
